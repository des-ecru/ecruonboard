...
class Varley_Home_Page:    
    ...
    def verify_main_banner(self, driver):
        ...
        if desktop_response.status_code == 200:
            ...
            print(f"Desktop video {desktop_video_url} failed to load. Status code: {desktop_response.status_code}")
    ...
    def verify_category_carousel(self, driver):
        ...
        expected_category_values = {
            ...
            "Sweatshirts": "https://www.varley.com/collections/hoodies-and-sweatshirts",
